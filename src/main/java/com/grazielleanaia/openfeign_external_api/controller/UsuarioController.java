...
import com.grazielleanaia.openfeign_external_api.infrastructure.security.SecurityConfig;
...
@Tag(name = "Usuario", description = "Registro de usuario")
...
public class UsuarioController {
    ...
    public ResponseEntity<ViaCepDTO> buscaDadosViaCep(@PathVariable("cep") String cep) {
        return ResponseEntity.ok(viaCepService.buscaEnderecoViaCep(cep));
    }
